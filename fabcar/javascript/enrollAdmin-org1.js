...
const adminUserId = 'org1admin'  //this will be used to identify in wallet
...
exports.enrollAdminOrg1 = async function() {
    try {
        ...
        const enrollment = await ca.enroll({ enrollmentID: 'admin', enrollmentSecret: adminPass}); //enrollment id -> what type of user it is
        const x509Identity = {
            credentials: {
